...
function(GitStateChangedAction _state_as_list)
    ...
    LIST(GET _state_as_list 2 GIT_DATE)
    LIST(GET _state_as_list 3 GIT_BRANCH)
...
function(GetGitState _working_dir _state)
    ...
    if(NOT res EQUAL 0)
        set(_success "false")
        set(_branch "GIT NOT FOUND")
    endif()

    # Return a list of our variables to the parent scope.
    set(${_state} ${_success} ${_hashvar} ${_date} ${_branch} PARENT_SCOPE)
endfunction()
