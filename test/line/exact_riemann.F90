...
npts = 1000 
if (npts .gt. n) then
 write (*,*) 'number of points exceeds array size'
 stop 1
endif
...
xr = 1.0
if (xr .lt. xl) then
 write (1,*) 'xr must be greater than xl'
 stop 1
endif
...
!..and do say what we found
write (*, 500)
write (*, 501) rho5, p5, u5
write (*, 602) rho4, p4, u4
write (*, 503) rho3, p3, u3
write (*, 604) 
write (*, 505) rho1, p1, u1
...
real(kind=8) function f(p4, p1, p5, rho1, rho5, gamma)
implicit none

!..shock tube equation

!..declare the pass
real(kind=8) :: p4,p1,p5,rho1,rho5,gamma

!..local variables
real(kind=8) :: z,c1,c5,gm1,gp1,g2,fact
