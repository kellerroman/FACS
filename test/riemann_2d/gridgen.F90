...
do j = 1, nj-1
   do i = 1, ni-1
      ...
      dy = dx * dble(i-1+0.5)
      if ( i > int(dble(ni) * 0.5d0) .and. &
           j > int(dble(nj) * 0.5d0) ) then
         cells(n) % Q(1) = 1.1d0
         cells(n) % Q(2) = 0.0d0
         cells(n) % Q(3) = 0.0d0
         cells(n) % Q(4) = 1.1d0     ! set pressure
      else if ( i <= int(dble(ni) * 0.5d0) .and. &
                j >  int(dble(nj) * 0.5d0) ) then
         cells(n) % Q(1) = 0.5065d0
         cells(n) % Q(2) = 0.8939d0
         cells(n) % Q(3) = 0.0d0
         cells(n) % Q(4) = 0.35d0     ! set pressure
      else if ( i <= int(dble(ni) * 0.5d0) .and. &
                j <= int(dble(nj) * 0.5d0) ) then
         cells(n) % Q(1) = 1.1d0
         cells(n) % Q(2) = 0.8939d0
         cells(n) % Q(3) = 0.8939d0
         cells(n) % Q(4) = 1.1d0     ! set pressure
      else
         cells(n) % Q(1) = 0.5065d0
         cells(n) % Q(2) = 0.0d0
